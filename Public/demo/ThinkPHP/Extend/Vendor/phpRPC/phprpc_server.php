...
class PHPRPC_Server {
    ...
    function initKey() {
        if ($this->encrypt == 0) {
            ...
            if (isset($session['key'])) {
                ...
                require_once('../demo/ThinkPHP/Extend/Vendor/phpRPC/xxtea.php');
                return;
            }
        }
        $this->errno = E_ERROR;
    ...
    function keyExchange() {
        require_once('../demo/ThinkPHP/Extend/Vendor/phpRPC/bigint.php');
        $this->initKeylen();
        ...
        if ($this->encrypt === true) {
            require_once('../demo/ThinkPHP/Extend/Vendor/phpRPC/dhparams.php');
    ...
    function PHPRPC_Server() {
        require_once('../demo/ThinkPHP/Extend/Vendor/phpRPC/compat.php');
